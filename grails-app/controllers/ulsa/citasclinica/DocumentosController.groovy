...
class DocumentosController {
    ...
    def save(Documentos documentos) {
        ...
        Integer n = 1
        Integer o = 0
        String doc = "C:/Users/Victor/Desktop/clinica/documentosCita/" + params.historiaCita.toString() + "d1.pdf"
        ...
        for(Integer g=0;g<l.size;g++){
            if(l[g].docUrl==doc){
                ...
                doc = "C:/Users/Victor/Desktop/clinica/documentosCita/" + params.historiaCita.toString() +"d"+n+ ".pdf"
                println doc
            }
        }
