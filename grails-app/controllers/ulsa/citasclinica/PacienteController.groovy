...
class PacienteController {
        ...
        if(paciente!=null){
            ...
            for(Integer i=0;i<citas.size;i++){
                if(HistoriaCita.findAll("from HistoriaCita where citas="+citas[i].id)!=null){
                    hist[n]=HistoriaCita.findAll("from HistoriaCita where citas="+citas[i].id)
                    n++
                }
            }
            [hist:hist]
    ...
    def crear() {
        ...
        String ine = "C:/Users/Victor/Desktop/clinica/ine/" + params.pNombre + params.pApPaterno + params.pApMaterno + ".pdf"
        String comprobante = "C:/Users/Victor/Desktop/clinica/comprobante/" + params.pNombre + params.pApPaterno + params.pApMaterno + ".pdf"
        String acta = "C:/Users/Victor/Desktop/clinica/acta/" + params.pNombre + params.pApPaterno + params.pApMaterno + ".pdf"
