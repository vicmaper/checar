        ...
        <div id="show-paciente" class="content scaffold-show" role="main">
            ...
            <fieldset align="center">
                <f:with bean="paciente">
                    ...
                    <p><b><label>Ine</label></b><g:link action="visualizacion" params="${[docUrl: paciente.urlIne]}" target="_blank" property="${urlIne}">${paciente.urlIne}
                            </g:link></p>
                    <p><b><label>Comprobante de Domicilio: </label></b><g:link action="visualizacion" params="${[docUrl: paciente.urlComp]}" target="_blank" property="${urlComp}">${paciente.urlComp}
                            </g:link></p>
                    <p><b><label>Acta de Nacimiento: </label></b><g:link action="visualizacion" params="${[docUrl: paciente.urlActa]}" target="_blank" property="${urlActa}">${paciente.urlActa}
                            </g:link></p>
